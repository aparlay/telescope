...
class WalletController
{
     ...
     *     path="/v1/wallet",
     *     tags={"wallets"},
     *     summary="create new payout wallet",
     *     description="To create a new user payout wallet use this endpoint",
     *     operationId="createPayoutWallet",
     *     security={{"bearerAuth": {}}},
     *     @OA\Parameter(
     *         name="X-DEVICE-ID",
     *         in="header",
     ...
     *         name="type",
     *         in="query",
     *         description="type of creating wallet, it could be 1=paypal, 2-bank, 3-crypto",
     *         required=true,
     *         @OA\Schema(
     *             type="int"
     *         )
     ...
     *     tags={"wallets"},
     *     summary="Fetch a signle wallet for current user",
     *     description="Fetch a signle wallet for current user",
     ...
     *     path="/v1/wallet",
     *     tags={"wallets"},
     *     summary="Fetch all wallets to payout for current user",
     *     description="Fetch all wallets to payout for current user",
