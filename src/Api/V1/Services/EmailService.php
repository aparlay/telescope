...
class EmailService extends AbstractService
{
    private array $errors = [
        '4.2.1' => 'The email account that you tried to reach is not currently accepting new email. Please try again later.', // The recipient's mailbox has exceeded its storage limit.
        ...
        '4.5.0' => 'Your email service provider has rejected our email. Please check your spam folder.', // Requested action not taken – The user's mailbox is unavailable. The mailbox has been corrupted or placed on an offline server, or your email hasn't been accepted for IP problems or blacklisting.
        '4.5.2' => 'Your email service provider has rejected our email. Please check your spam folder.', // Too many emails sent or too many recipients: more in general, a server storage limit exceeded.
        '4.7.1' => 'Your email service provider has rejected our email. Please check your spam folder.', // An error of your mail server, often due to an issue of the local anti-spam filter.
        ...
        '5.3.0' => 'Your email service provider has rejected our email. Please check your spam folder.', // Normally, an authentication problem. But sometimes it's about the recipient's server blacklisting yours, or an invalid email address.
        '5.4.1' => 'Your email service provider has rejected our email. Please check your spam folder.', // The recipient address rejected your message: normally, it's an error caused by an anti-spam filter.
