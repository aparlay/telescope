...
class ProcessMedia implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        if ($status->code !== 0) {
            ...
            $media->save(['status', 'length', 'processing_log']); //false, ['status', 'length', 'processing_log']
        }
        ...
        if ($response instanceof OptimizeResponse) {
            ...
            $media->save(); //false, ['status', 'length', 'processing_log']
        }
        ...
        $media->save(); //false, ['status', 'file', 'length', 'processing_log']
        ...
        $media->save(); //true, ['status', 'length', 'processing_log', 'file']
