...
class MediaBatchWatched implements ShouldQueue
{
     ...
     * @throws Exception
     */
    public function __construct(public array $medias, public string|null $userId = null, public string|null $uuid = null)
    {
        $this->onQueue('low');
    }
    ...
    public function handle(): void
    {
        ...
        foreach (Media::query()->whereIn('_id', $mediaIds)->get() as $media) {
            $mediaService->watched($media, $durations[(string) $media->_id], $this->userId, $this->uuid);
        }
    }
