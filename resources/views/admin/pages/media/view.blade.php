                                                    ...
                                                    @foreach (\Aparlay\Core\Models\Enums\MediaContentGender::getAllCases() as $value => $label)
                                                        <div id="content_gender" class="btn-group btn-group-toggle beauty_score_div" data-toggle="buttons" role="radiogroup">
                                                            <label class="btn btn-outline-secondary content_gender_label" for="media_content_gender_{{$value}}">
                                                                <input type="radio" id="media_content_gender_{{$value}}" name="content_gender" value="{{ $value }}" data-index="{{ $value }}" autocomplete="off" @if($media->skin_score >= 1 && $media->beauty_score >= 1 && $media->awesomeness_score >= 1 && $media->content_gender == $value) checked @endif>
                                                                {{ $label }}
                                                            </label>
                                                        </div>
                                                    @endforeach
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="media-info">
                                    <form action="{{route('core.admin.media.update', ['media' => $media->_id])}}"
                                        ...
                                        <div class="form-group row m-0">
                                            <label for="visits" class="col-sm-4 col-form-label">Watched Length</label>
                                            <div class="col-sm-8 mt-2">
